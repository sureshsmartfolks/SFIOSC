...
namespace OwinSelfhostSample
{
    ...
    {
        #region "searchTU"
        public List<TranslationResponse> SearchForText(string tmPath, string searchText, SearchMode mode)
        {
            ...
            #region "histlist"
            //string hitList = "{";
            List<TranslationResponse> hitList = new List<TranslationResponse>();
            ...
            //    hitList += "Match value: " + result.ScoringResult.Match.ToString() + "\n\n";
                //hitList += "[Translation: '" + result.MemoryTranslationUnit.TargetSegment.ToPlain() + "',Score: " + result.ScoringResult.Match.ToString() + "],";
                TranslationResponse trans = new TranslationResponse
                {
                    Translation = result.MemoryTranslationUnit.TargetSegment.ToPlain(),
                    Score = result.ScoringResult.Match,
                    Culture = result.MemoryTranslationUnit.TargetSegment.Culture.ToString()
                };
                hitList.Add(trans);
            }
